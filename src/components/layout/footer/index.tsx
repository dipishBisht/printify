...
export default function Footer() {
    return (
        <footer className=" border-white/10 pt-20 pb-8 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <Link
                                href="#"
                                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/70 hover:text-[#6f41d2] hover:bg-white/10 transition-colors"
                            >
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex">
                                <Input
                                    ...
                                    className="bg-white/5 border-white/10 rounded-l-lg focus-visible:ring-[#6f41d2]"
                                />
